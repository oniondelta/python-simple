...
# 使用模組 module
from py2py_modules.iof import IOfile
from py2py_modules.py2py import Pinyin2Pinyin
from py2py_modules.rd5 import RemoveDuplicate5
from py2py_modules.ckpy import CheckPinyin
...
output_1="ok_py2py.txt"
output_2="output_finish-py2py_rd5.txt"
